export const Scripts: ModdedBattleScriptsData = {
	init() {
		...
		this.modData('Learnsets', 'giratinaaltered').learnset.nastyplot = ['5L1'];
		this.modData('Learnsets', 'giratinaaltered').learnset.swordsdance = ['5L1'];
		this.modData('Learnsets', 'giratinaaltered').learnset.dragondance = ['5L1'];
		this.modData('Learnsets', 'giratinaaltered').learnset.roost = ['5L1'];
